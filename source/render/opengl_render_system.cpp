...
void OpenglRenderSystem::Init()
{
  ...
  defaultShader = std::make_unique<OpenglShader>(PPCAT(SHADERS_DIR, DEFAULT_VERTEX_SHADER), PPCAT(SHADERS_DIR, DEFAULT_FRAGMENT_SHADER));
...
void OpenglRenderSystem::RenderScene(Camera* camera, float ratio)
{
